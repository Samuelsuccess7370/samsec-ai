      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-12 lg:px-20">
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-12 mb-16 md:mb-20">
          ...
          <div className="max-w-sm flex flex-col items-center md:items-start text-center md:text-left">
            <Link to={RoutePath.HOME} className="flex items-center space-x-2 mb-6 group">
          ...
          <div className="flex flex-col md:flex-row gap-12 md:gap-32 text-center md:text-left">
            <div>
              ...
              <ul className="space-y-4">
                <li><Link to={RoutePath.SYSTEM} className="text-gray-500 hover:text-white text-xs uppercase tracking-widest transition-colors font-bold">The System</Link></li>
                <li><Link to={RoutePath.ABOUT} className="text-gray-500 hover:text-white text-xs uppercase tracking-widest transition-colors font-bold">Our Mission</Link></li>
                <li><Link to={RoutePath.CONTACT} className="text-gray-500 hover:text-white text-xs uppercase tracking-widest transition-colors font-bold">Secure Support</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li><Link to={RoutePath.REFUNDS} className="text-gray-500 hover:text-white text-xs uppercase tracking-widest transition-colors font-bold">Refund Policy</Link></li>
                <li><Link to={RoutePath.TERMS} className="text-gray-500 hover:text-white text-xs uppercase tracking-widest transition-colors font-bold">Terms of Service</Link></li>
                <li><Link to={RoutePath.PRIVACY} className="text-gray-500 hover:text-white text-xs uppercase tracking-widest transition-colors font-bold">Privacy Policy</Link></li>
                <li><Link to={RoutePath.DISCLAIMER} className="text-gray-500 hover:text-white text-xs uppercase tracking-widest transition-colors font-bold">Disclaimer</Link></li>
              </ul>
            </div>
          </div>
        </div>
