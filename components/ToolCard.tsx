        ...
        {comingSoon ? (
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <a 
              ...
              className="flex-1 flex items-center justify-center gap-2 bg-white text-black py-2.5 rounded-lg text-sm font-bold hover:bg-secondary hover:text-white transition-all shadow-lg shadow-white/5"
            >
