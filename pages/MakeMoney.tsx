        ...
        <div className="space-y-6">
          {strategies.map((strategy, idx) => (
            <GlassCard key={idx} className="flex flex-col md:flex-row items-center justify-between p-8 gap-6">
               ...
               <button className="bg-white text-black px-6 py-3 rounded-lg font-bold transition-all duration-300 hover:shadow-[0_0_20px_rgba(255,255,255,0.3)] hover:-translate-y-1 w-full md:w-auto">
                 Unlock Guide
               </button>
            </GlassCard>
          ))}
